...
namespace Klinika.Intranet.Controllers
{
    public class KontaktController : Controller
    {
        ...
        public KontaktController(KlinikaIntranetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKontaktu,TytułKontakt,NumerTelefonu,NazwaKontaktu,PozycjaWyswietlania,CzyAktywny")] Kontakt kontakt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKontaktu,TytułKontakt,NumerTelefonu,NazwaKontaktu,PozycjaWyswietlania,CzyAktywny")] Kontakt kontakt)
        {
