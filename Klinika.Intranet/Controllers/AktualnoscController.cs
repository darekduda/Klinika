...
namespace Klinika.Intranet.Controllers
{
    public class AktualnoscController : Controller
    {
        ...
        public AktualnoscController(KlinikaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAktualnosci,Nazwa,Opis,CzyAktywny")] Aktualnosc aktualnosc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAktualnosci,Nazwa,Opis,CzyAktywny")] Aktualnosc aktualnosc)
        {
